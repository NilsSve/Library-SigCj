...
Cd_Popup_Object oCalendar_Categories_sl is a cSigCjdbModalPanel
    Set Label to "Catergory Lookup List"
    Set Size to 134 238
    Set Location to 4 5
//    Set pbMatchSearch to True

    Object oC_Categ_DD is a cC_CategDataDictionary
    End_Object // oC_Categ_DD
    ...
    Object oSelList is a cSigCjCJGridPromptList
        ...
        Procedure OnLoad_Columns
            Handle hoColumn
            Get Add_Column File_Field c_Categ.Description 200 "Name" to hoColumn
        End_Procedure

    End_Object // oSelList

Cd_End_Object // oCalendar_Categories_sl
